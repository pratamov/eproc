...
public class AbstractContractorController extends InternalAPIController {
	...
	@GetMapping(path="/v1/contractors/procurements")
	...
	@GetMapping(path="/v1/contractors/procurements/{procurement_id}")
	...
	@PostMapping(path="/v1/contractors/procurements")
	...
	@PutMapping(path="/v1/contractors/procurements/{procurement_id}")
	...
	@DeleteMapping(path="/v1/contractors/procurements/{procurement_id}")
	...
	@GetMapping(path="/v1/contractors/proposals")
	...
	@GetMapping(path="/v1/contractors/proposals/{proposal_id}")
	...
	@PostMapping(path="/v1/contractors/proposals")
	...
	@PutMapping(path="/v1/contractors/proposals/{proposal_id}")
	...
	@DeleteMapping(path="/v1/contractors/proposals/{proposal_id}")
	...
	@GetMapping(path="/v1/contractors/users")
	...
	@GetMapping(path="/v1/contractors/users/{user_id}")
	...
	@PostMapping(path="/v1/contractors/users")
	...
	@PutMapping(path="/v1/contractors/users/{user_id}")
	...
	@DeleteMapping(path="/v1/contractors/users/{user_id}")
